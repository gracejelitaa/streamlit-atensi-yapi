...
from pages import dashboard, upload_data, preprocessing, kmeans, kmedoids, perbandingan, hasil_akhir, panduan
...
def main():
    ...
    with st.sidebar:
        ...
        selected = option_menu(
            menu_title=None,
            options=[
                "Dashboard", "Upload Data", "Preprocessing",
                "K-Means", "K-Medoids", "Perbandingan",
                "Hasil Akhir", "Panduan",
            ],
            icons=[
                "house", "cloud-upload", "gear",
                "bar-chart", "diagram-3", "sliders",
                "file-earmark-text", "question-circle",
            ],
            default_index=0,
            styles={
